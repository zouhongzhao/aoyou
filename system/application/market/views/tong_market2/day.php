 ...
 jQuery("#list10").jqGrid({
	...
	jQuery("#list10_d").jqGrid({
		...
		datatype: "json",
	   	...
	   	colModel:[
	   		{name:'main[u_id]',index:'u_id', width:55,align:"center"},
	   		{name:'main[dates]',index:'dates',search:false, width:100,align:"center"},
	   		{name:'main[activation]',index:'activation',search:false, width:100,align:"center"},
	   		{name:'main[install_num]',index:'install_num',search:false, width:100,align:"center"},	
	   		{name:'main[mac_num]',index:'mac_num',search:false,width:100,align:"center"},
	   		{name:'main[shouyis]',index:'shouyis',search:false, width:100,align:"center"}
	   	],
	   	rowNum:5,
	   	rowList:[5,10,20],
	   	pager: '#pager10_d',
