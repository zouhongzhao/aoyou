...
<?php
	...
	echo form_open("award/award_save/1",array("id"=>"form1","enctype"=>"multipart/form-data"));
?>
<table>
<tr>
...
<tr>
	...
	<td class="left">
	<img src="<?php echo $main['award_thumbnail'];?>"/>    <p class="slide"><a href="#" id="btn-slide">修改图片</a></p>
...
<tr>
	...
	<td class="left"><textarea id="main[award_descrption]" name="main[award_descrption]"><?php echo $main['award_descrption'];?></textarea><?php echo $this->ckeditor->replace("main[award_descrption]");?></td>
</tr>
</table>
<script type="text/javascript">
$(document).ready(function(){
	$("#btn-slide").click(function(){
		$("#fileimg").slideToggle("slow");
