...
<table class="mytable">
	...
	<tr class="tr_center">
		...
		<td><?php echo date("y-m-d h:m:s",$v['admin_ctime']); ?></td>
		<td>
		<?php if($v['admin_type']==1) echo "超级管理员"; 
			else echo "市场部管理员";
		?></td>
		<td>
		<?php 
			...
			echo anchor_popup('admins/admins_add','&nbsp;',$attrs); ?>
			<?php 
			$attrs  = array(
				'class'=>'link_mod',
				'title' => '修改',
			);
			echo anchor_popup('admins/admins_add/'.$v['admin_id'],'&nbsp;',$attrs); ?>
