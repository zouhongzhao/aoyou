<?php
	echo form_fieldset("修改直属渠道会员");
// 	echo form_open("users/users_save");
?>
<form method="post" action="<?=site_url()?>?users/users_save/1" name="uadd" id="uadd">
<script type="text/javascript" defer="defer" src="<?=base_url()?>js/area.js"></script>
<table>
<tr>
	<td class="right">渠道号：</td>
	<td class="left"><input type="text" readonly="readonly" name="main[us_name]"  value="<?php echo set_value('main[us_name]',$main['us_name']);?>" />
	*
...
<tr>
	...
	<select name="main[us_type]">
		<option value='channels' selected>直属渠道会员</option>
		</select></td>
</tr>
<tr>
...
<input type="hidden" name="main[under]" value="1" size="50" />
